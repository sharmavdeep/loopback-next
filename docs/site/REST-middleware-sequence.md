...
responds to incoming requests. Different types of servers, such as RestServer,
GraphQLServer, GRPCServer, and WebSocketServer, will have their own flavor of
sequence.
...
have only modified the code by adding `authenticate` action per our docs, you
